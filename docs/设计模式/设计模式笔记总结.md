...
![img](设计模式笔记总结.assets/UML类图总结.png)
...
+ 被Template Method调用的**虚方法**可以（抽象方法、纯虚方法），但一般推荐将它们设置为`protected`方法。
  ...
  ![img](设计模式笔记总结.assets/早绑定晚绑定.png)
...
+ Decorator模式的目的并非解决“多子类衍生的多继承”问题，**Decorator模式应用的要点在于解决“主体类在多个方向上的扩展功能”——是为“装饰”的含义**。
  ...
  **示例1内部继承结构**
  ...
  ![img](设计模式笔记总结.assets/装饰者1.png)

  实例2：**用组合代替继承**，运行时编译

  实例3：将共同的部分提出，类关系图如下,子类大大减少

  ![img](设计模式笔记总结.assets/装饰者2.png)
...
![img](设计模式笔记总结.assets/抽象工厂结构.png)
...
![img](设计模式笔记总结.assets/原型模式结构.png)
...
![img](设计模式笔记总结.assets/门面模式复杂.png)
...
![img](设计模式笔记总结.assets/门面模式结构.png)
...
![img](设计模式笔记总结.assets/代理模式结构.png)
...
![img](设计模式笔记总结.assets/中介结构.png)

concreteCollegue本身是相互依赖的，经过中介，不相互依赖了。Meidator和Colleague相互依赖。

![img](设计模式笔记总结.assets/中介者加深理解.png)
...
![img](设计模式笔记总结.assets/状态模式定义.png)
...
![img](设计模式笔记总结.assets/组合模式结构.png)
...
![img](设计模式笔记总结.assets/命令模式结构.png)
...
![img](设计模式笔记总结.assets/解释器模式结构.png)
