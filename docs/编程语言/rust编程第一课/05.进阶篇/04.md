...
不知道在其它编程语言中有没有类似的概念，反正我所了解的语言，没有类似的东西。C加加 虽然允许你编译 lib A 时用 \--std=C加加17，编译 lib B 时用 \--std=C加加20，但这种用法有不少局限，用起来也没有版次这么清爽。我们先对它的理解达成一致，再聊这次“版次”更新的重点内容。
...
![](./httpsstatic001geekbangorgresourceimageb853b8601e7c005ff666d1597dd174346d53.jpg)
