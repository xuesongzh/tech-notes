...
![](./httpsstatic001geekbangorgresourceimage86b1864926c69c3c85c7df771374f78942b1.jpg)
...
![](./httpsstatic001geekbangorgresourceimage571b572da99aeee859f8b7cbcf6ebfe9ea1b.jpg)

C语言的结构体struct和C++语言的对象，都可以保存在栈里。保存在栈里的对象是直接声明并实例化的，而不是用new关键字来创建的。如果用new关键字来创建，实际上是在堆里申请了一块内存，并赋值给一个指针变量，如下图所示：

![](./httpsstatic001geekbangorgresourceimage157215313f8205fa80912e72718685755072.jpg)
